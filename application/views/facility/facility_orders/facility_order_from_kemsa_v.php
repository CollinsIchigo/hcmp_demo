...
<div class="row" style="padding-left: 1%;margin-bottom: 5px;">
	...
	<!--<div class="col-md-2">
		random number is generated by Javascript and saved with the order
     <b>*Order No:</b> <input type="hidden" class="form-control input_text" name="order_no" id="order_no" id="order_no" required="required" />
	</div>
<!--<div class="col-md-2">
